                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="product-pic-zoom">
                            <img class="product-big-img" src="http://127.0.0.1:8000/productImages/{{$images[0]}}"
                                alt="">
                            <div class="zoom-icon">
                        ...
                        <div class="product-thumbs">
                            <div class="product-thumbs-track ps-slider owl-carousel">
                                <div class="pt active"
                                    data-imgbigurl="http://127.0.0.1:8000/productImages/{{$images[0]}}"><img
                                        src="http://127.0.0.1:8000/productImages/{{$images[0]}}" alt=""></div>
                                @foreach($images as $productImg)
                                <div class="pt" data-imgbigurl="http://127.0.0.1:8000/productImages/{{$productImg}}">
                                    <img src="http://127.0.0.1:8000/productImages/{{$productImg}}" alt=""></div>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="product-details">
                            ...
                            <div class="pd-rating">
                                @for($i = 0 ; $i<(int)$avg_stars;$i++) <i class="fa fa-star"></i>
                                    @endfor
                                    @for($j = $i ; $j<5;$j++) <i class="fa fa-star-o"></i>
                                        @endfor
                                ...
                                <div class="customer-review-option">
                                    ...
                                    <div class="leave-comment">
                                        ...
                                        <form action="{{ route('addComment') }}" method="POST" class="comment-form">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-7">
                                                    <input type="number" placeholder="Your Raiting" min=0 max=5
                                                        maxlength=1 name="stars" required>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="http://127.0.0.1:8000/productImages/{{$relatedProductsImages[$i]}}" alt="">
                                <div class="icon">
                                ...
                                <ul>
                                    <li class="w-icon active">
                                        <form action="/addToCart" method="POST">
                                            ...
                                            <input class="pro-qty" type="hidden" min=1
                                                value={{isset($relatedProduct)?$relatedProduct->id : null}}
                                                name="product_id">
                                            <button type="submit"> <i class="fa fa-cart-plus"></i> </button>
                                        </form>
                                    </li>
                                    <li class="quick-view"><a
                                            href="{{url('/shopFinal-single/'.$relatedProduct->id.'')}}">+ Quick View</a>
                                    </li>
