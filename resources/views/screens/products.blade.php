        ...
        <ul>
            <li class="lifilter">
                ...
                <ul>
                    ...
                    <li class="sublifilter">
                        <label>
                            <input type="checkbox" value="Turf Soccer Shoes" id="Turf_Soccer_Shoes" />
                            <div></div>
                            Turf Soccer Shoes
                            <source />
                        </label>
                    ...
                    <li class="sublifilter">
                        <label>
                            <input type="checkbox" value="Indoor Soccer Shoes" id="Indoor_Soccer_Shoes" />
                            <div></div>
                            Indoor Soccer Shoes
                        </label>
                    </li>
                    <li class="sublifilter">
                        <label>
                            <input type="checkbox" value="Lifestyle Shoes" id="Lifestyle_Shoes" />
                            <div></div>
                            Lifestyle Shoes
                        </label>
                    </li>
                    <li class="sublifilter">
                        <label>
                            <input type="checkbox" value="Artificial Ground" id="Artificial_Ground" />
                            <div></div>
                            Artificial Ground
                        </label>
                    </li>
            ...
            <li class="lifilter">
                ...
                <ul>
                    ...
                    <li class="sublifilter">
                        <label>
                            <input type="checkbox" value="$50.00 - $75.00" id="_$50.00_$75.00" />
                            <div></div>
                            $50.00 - $75.00
                        </label>
                    </li>
                    <li class="sublifilter">
                        <label>
                            <input type="checkbox" value="$75.00 - $100.00" id="_$75.00_$100.00" />
                            <div></div>
                            $75.00 - $100.00
                        </label>
                    </li>
                    <li class="sublifilter">
                        <label>
                            <input type="checkbox" value="$100.00 - $150.00" id="_$100.00_$150.00" />
                            <div></div>
                            $100.00 - $150.00
                        </label>
                    </li>
        ...
        <div class="product">
            ...
            <div class="love">
                ...
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                    y="0px" width="29.96px" height="26.79px" viewBox="0 0 29.96 26.79"
                    style="enable-background:new 0 0 29.96 26.79;" xml:space="preserve">
                    <style type="text/css">
                        .st0 {
                            fill-rule: evenodd;
                            clip-rule: evenodd;
                    ...
                    <defs></defs>
                    <path class="st0" d="M29.21,9c0,2.38-0.92,4.6-2.91,6.97c-1.77,2.13-4.32,4.32-7.28,6.84c-1.09,0.95-2.23,1.92-3.44,2.99l-0.04,0.03
